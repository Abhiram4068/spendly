      ...
      <div className="flex items-center gap-2">
        {categories && setFilterCategory && (
          <div className="relative shrink-0">
            <select value={filterCategory} onChange={(e) => setFilterCategory(e.target.value)} className="rounded-lg pl-2.5 pr-6 py-1.5 text-sm outline-none appearance-none" style={inputStyle}>
